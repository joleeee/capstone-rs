...
impl Clone for __darwin_arm_thread_state {
    fn clone(&self) -> Self {
        *self
    }
}
...
impl Clone for __darwin_arm_vfp_state {
    fn clone(&self) -> Self {
        *self
    }
}
impl ::core::fmt::Debug for __darwin_arm_vfp_state {
...
impl Clone for __darwin_arm_debug_state64 {
    fn clone(&self) -> Self {
        *self
    }
}
...
impl Clone for __darwin_arm_cpmu_state64 {
    fn clone(&self) -> Self {
        *self
    }
}
...
#[doc = " This is associated with ARM64_OP_SME_INDEX operand type above"]
#[repr(C)]
#[derive(Debug, Copy)]
...
pub union cs_arm64_op__bindgen_ty_2 {
    ...
    #[doc = "< arm64_dc_op, arm64_at_op, arm64_tlbi_op)"]
...
#[doc = " Instruction's operand referring to memory"]
#[doc = " This is associated with TRICORE_OP_MEM operand type above"]
#[repr(C)]
#[derive(Debug, Copy)]
